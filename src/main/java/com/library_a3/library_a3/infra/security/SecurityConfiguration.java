        ...
        return httpSecurity
                ...
                .authorizeHttpRequests(
                        authorize -> authorize
                                ...
                                .requestMatchers(HttpMethod.DELETE, "/students/{id}").hasAuthority(Role.EMPLOYEE.toString())
                                ...
                                .requestMatchers(HttpMethod.DELETE, "/books/{id}").hasAuthority(Role.EMPLOYEE.toString())
